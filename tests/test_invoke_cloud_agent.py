...
"""
Test the lambda_handler function in source/invoke_cloud_agent.py
"""
...
def test_lambda_handler_success(mock_run_agent):
    mock_run_agent.return_value = 'Hello World!'
...
def test_lambda_handler_missing_user_input():
    ...
    assert response['body'] == '{"error": "User input is required"}'
